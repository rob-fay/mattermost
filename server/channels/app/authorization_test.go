	...
	testCases := []struct {
		...
		},
		{
			...
			field: &model.PropertyField{
				...
				PermissionField:   new(model.PermissionLevelMember),
		...
		},
		{
			...
			field: &model.PropertyField{
				...
				PermissionValues:  new(model.PermissionLevelMember),
				PermissionOptions: new(model.PermissionLevelSysadmin),
			},
			expected: false,
		},
		{
		...
		},
		{
			...
			field: &model.PropertyField{
				...
				Type:              model.PropertyFieldTypeText,
				TargetType:        string(model.PropertyFieldTargetLevelSystem),
				PermissionField:   new(model.PermissionLevelSysadmin),
				PermissionValues:  new(model.PermissionLevelMember),
				PermissionOptions: new(model.PermissionLevelSysadmin),
			},
			expected: true,
	...
	testCases := []struct {
		...
		},
		{
			...
			field: &model.PropertyField{
				...
				PermissionField:   new(model.PermissionLevelSysadmin),
				PermissionValues:  new(model.PermissionLevelSysadmin),
				PermissionOptions: new(model.PermissionLevelSysadmin),
			},
			expected: true,
		},
		...
		},
		{
			...
			field: &model.PropertyField{
				...
				TargetType:        string(model.PropertyFieldTargetLevelSystem),
				PermissionField:   new(model.PermissionLevelSysadmin),
				PermissionValues:  new(model.PermissionLevelNone),
				PermissionOptions: new(model.PermissionLevelSysadmin),
			},
			expected: false,
		},
	...
	testCases := []struct {
		...
		},
		{
			...
			field: &model.PropertyField{
				...
				PermissionField:   new(model.PermissionLevelSysadmin),
				PermissionValues:  new(model.PermissionLevelMember),
				PermissionOptions: new(model.PermissionLevelNone),
			},
			expected: false,
		},
		{
