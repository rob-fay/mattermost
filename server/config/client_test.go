	...
	}{
		{
			...
			&model.Config{
				EmailSettings: model.EmailSettings{
					EmailNotificationContentsType: new(model.EmailNotificationContentsFull),
				},
		...
		},
		{
			...
			&model.Config{
				PluginSettings: model.PluginSettings{
					MarketplaceURL: new(model.PluginSettingsDefaultMarketplaceURL),
				},
			},
			"tag1",
			nil,
		...
		},
		{
			...
			&model.Config{
				IntuneSettings: model.IntuneSettings{
					...
					AuthService: new(model.ServiceOffice365),
				},
			},
			"",
			&model.License{
		...
		},
		{
			...
			&model.Config{
				IntuneSettings: model.IntuneSettings{
					...
					TenantId:    new("12345678-1234-1234-1234-123456789012"),
					ClientId:    new("87654321-4321-4321-4321-210987654321"),
					AuthService: new(model.UserAuthServiceSaml),
				},
